...
;(function( $ ) {
	$.fn.eventCalendar = function(options){
		...
		this.each(function(){
			...
			flags.wrap = $(this);
			flags.wrap.addClass('eventCalendar-wrap').append("<div class='eventCalendar-list-wrap'><p class='eventCalendar-subtitle'></p><p class='button-place' data='' style='display:none;'></p><span class='eventCalendar-loading'>"+eventsOpts.txt_loading+"</span><div class='eventCalendar-list-content'><ul class='eventCalendar-list'></ul></div></div>");
		...
		function dateSlider(show) {
			...
			for (dayCount = 1; dayCount <= daysOnTheMonth; dayCount++) {
				...
				daysList.push('<li id="dayList_' + dayCount + '" rel="'+dayCount+'" date="'+year+'-'+Number(month+1)+'-'+dayCount+'" month="'+Number(month+1)+'" year="'+year+'" class="eventCalendar-day '+dayClass+'"><a href="#">' + dayCount + '</a></li>');
			}
	...
	$.fn.eventCalendar.defaults = {
		...
		txt_noEvents: "There are no events in this period. <br> <a href='' id='add_period' date=''>Want to add period here.</a>",
		txt_SpecificEvents_prev: "",
		txt_SpecificEvents_after: "events:",
		txt_next: "next",
		txt_prev: "prev",
		txt_NextEvents: "This Month Schedule:",
