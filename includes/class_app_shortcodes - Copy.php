...
*/
		...
		$script .= '$.post(_appointments_data.ajax_url, post_data, function(response) {
						...
						if ( response && response.error ) {
							...
							if(attendees > 6 ){
							var first_six = new_price*6;
							var new_attendence = attendees - 6 ;
							if (refund == "twenty"){
							var price = 20;
							}else{
							var price = 55;
							}
							var new_price =  price*attendees ;
							}else{
							...
							var new_price = new_price-coupon_price;
							}
